...
function generateMockGithubData(): GithubData {
  ...
  for (let w = 0; w < 53; w++) {
  ...
  }  const mockRepos: RepoNode[] = [
    {
      ...
      url: "https://github.com/Deigowo/Deigowo",
                    ...
                    <Box>
                      <Flex justify="between" align="center" className="mb-3 flex-wrap gap-2">
                        <Flex align="center" gap="2" className="flex-wrap">
                          ...
                          {(() => {
                            const isCollaborator = repo.owner && repo.owner !== "Deigowo";
               ...
               <Box className="md:col-span-2">
                <Card variant="surface" style={{ height: '100%', background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.05)' }} className="flex flex-col justify-between p-5 sm:p-6">
                  ...
                  <Box className="mt-6 pt-6 border-t border-white/5">
                    <a
                      href="/CV_RiveraSanchezDiegoNicolas_2025.pdf"
                      download="CV_RiveraSanchezDiegoNicolas_2025.pdf"
                  ...
                  >
                    ...
                    <Box className="pt-4 border-t border-white/5 flex justify-between align-center">
                      ...
                      <Flex gap="3" align="center">
                        ...
                        {proj.name === "Deigowo Portfolio" && (
                          <Link href="https://deigowo.dev" target="_blank" size="1" color="gold" className="flex items-center gap-1 hover:underline">
              ...
              <Flex justify="center" align="center" gap="4" className="pt-4">
                <Tooltip content={lang === 'es' ? 'Enviar correo' : 'Send email'}>
                  <IconButton size="3" variant="solid" color="gold" radius="full" style={{ cursor: 'pointer' }} asChild>
                    <a href="mailto:deigowo@gmail.com">
                      <IconMail />
                    </a>
                  </IconButton>
                </Tooltip>
                ...
                <Tooltip content="GitHub">
                  <IconButton size="3" variant="solid" color="gold" radius="full" style={{ cursor: 'pointer' }} asChild>
                    <a href="https://github.com/Deigowo" target="_blank" rel="noopener noreferrer">
                      <IconGithub />
                    </a>
                  </IconButton>
                </Tooltip>
                ...
                <Tooltip content="LinkedIn">
                  <IconButton size="3" variant="solid" color="gold" radius="full" style={{ cursor: 'pointer' }} asChild>
                    <a href="https://www.linkedin.com/in/diego-nicol%C3%A1s-rivera-s%C3%A1nchez-a0a844317/" target="_blank" rel="noopener noreferrer">
                      <IconLinkedin />
                    </a>
                  </IconButton>
                </Tooltip>
