...
const OriginalScene = dynamic(
  () =>
    import("@/components/OriginalScene").then((m) => ({
      default: m.OriginalScene,
    })),
  { ssr: false },
);
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("touchmove", onVisualInteract, {
      passive: true,
      once: true,
    });
    window.addEventListener("mousedown", onVisualInteract, {
      passive: true,
      once: true,
    });
    window.addEventListener("keydown", onVisualInteract, {
      passive: true,
      once: true,
    });
